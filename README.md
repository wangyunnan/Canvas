...
## 📣 Update Log
- [2025.4.01] 🎉 We release the pre-trained Canvas and CreaCulture at HuggingFace ([Model](https://huggingface.co/wangyunnan/Canvas)&[Dataset](https://huggingface.co/datasets/wangyunnan/CreaCulture)). 
